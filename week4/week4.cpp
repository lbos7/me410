...
#define P_PITCH 15.0
#define D_PITCH 4.0
#define I_PITCH 0.1*0

#define I_SAT 100.0

#define THRUST_NEUTRAL 800.0
#define THRUST_AMP     100.0

#define PITCH_AMP 10.0
...
#define MOTOR_1 motor_commands[0] // 1
#define MOTOR_2 motor_commands[1] // 0
#define MOTOR_3 motor_commands[2] // 3
#define MOTOR_4 motor_commands[3] // 2
...
int main (int argc, char *argv[])
{
    ...
    while(run_program)
    {
        ...
        safety_check();
        pitchController();
        printf("%f,%f,%f,%f,%d,%d\n", time_now,pitch_acc,pitch_angle,desired_pitch,motor_commands[0],motor_commands[1]); // blue red yellow
        sched_yield();
...
void pitchController()
{
    float pitch_mul = (128 - shared_memory->pitch)/128.0;
    float thrust_mul = (128 - shared_memory->thrust)/128.0;
