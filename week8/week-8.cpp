...
#define JOYSTICK_PAUSE_BUTTON key3
#define JOYSTICK_RESUME_BUTTON key0
#define JOYSTICK_AUTO_BUTTON key2 //X
//gcc -o week1 week_1_student.cpp -lwiringPi -lm

// Pitch PID 

#define P_PITCH 10.0*0
#define D_PITCH 2.0*0
#define I_PITCH 0.05*0

#define PITCH_ERR_CLIP 1.0

// Roll PID 

#define P_ROLL 12.0*0
#define D_ROLL 2.5*0
#define I_ROLL 0.05*0

// Yaw P

#define P_YAW 5.5
#define P_AUTO_YAW 3.0

#define I_SAT 100.0

#define THRUST_NEUTRAL 1200.0*0
...
void PIDcontroller()
{
    ...
    if (autonomus_yaw)
    {
      ...
      printf("Yaw speed = %f , desired = %d \n",imu_data[3],camera_data.yaw);
      // sleep(1);
    }
    else
    {
