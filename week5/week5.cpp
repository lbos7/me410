...
#define JOYSTICK_PAUSE_BUTTON key0
#define JOYSTICK_RESUME_BUTTON key3
...
#define THRUST_NEUTRAL 1000.0*0
#define THRUST_AMP     100.0

#define PITCH_AMP 10.0
#define ROLL_AMP 10.0
#define YAW_AMP 50.0
...
int main (int argc, char *argv[])
{
    ...
    while(run_program)
    {
        ...
        PIDcontroller();
        checkMotorPause();
        printf("%f,%f,%f,%d,%d,%d,%d\n", time_now,roll_angle,desired_roll,motor_commands[0],motor_commands[1],motor_commands[2],motor_commands[3]); // blue red yellow
        // printf("%f\n",roll_angle);
...
void PIDcontroller()
{
    ...
    float desired_yaw_speed =  yaw_mul*YAW_AMP;
